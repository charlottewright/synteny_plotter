...
for (i in args$busco_list){
  ...
  Q_chromosomes <- generate_auto_query_order(R_chromosomes, R_df, Q_df)
  # Q_chromosomes <- read.table(args$chrom_list[counter], sep = '\t', header = TRUE)
  # Q_chromosomes_auto <- generate_auto_query_order(R_chromosomes, R_df, Q_df) # - maybe the function needs to be a bit adjusted
  # print("ORIGINAL:")
